...
export const FoodieReceiptEmail = () => (
  <Html>
    <Head />
    <Preview>Foodie Cart Receipt</Preview>
      ...
      <Container style={container}>
        <Section>
          <Row>
            <Column>
              <Img
                src='https://sa-east-1.graphassets.com/cluzo2nxa0ew307m02s1p0w8r/output=format:jpg/resize=height:800,fit:max/clvlmfqvv0ddu07lvciapcglq'
                width="92"
                height="62"
              ...
              <Section>
                <Row>
                  <Column style={informationTableColumn}>
                    <Text style={informationTableLabel}>USER EMAIL</Text>
                    <Link
                      style={{
...
export default FoodieReceiptEmail;
